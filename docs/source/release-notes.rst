...
* **Configurable authorization and authentication data sources**
    Corda now supports the configuration of the external sources of user  authentication including support for the Apace Shiro Modular Crypt Format encoded passwords
...
=============
  ...
  * ??? Performance improvements ( <<< check with Rick to see if / how many we've re-added >>> )
  * Many bug fixes
